...
export const AnyErrorResponse = (value?: keyof typeof apiErrors | Error) => {
...
export const SuccessResponse = <T>(item?: T, headers?: HeadersInit) => {
  return Response.json({
    success: true,
    item,
  }, { headers })
...
export const SuccessItemsResponse = <T>(items?: T[], headers?: HeadersInit) => {
  return Response.json({
    success: true,
    items,
  }, { headers })
